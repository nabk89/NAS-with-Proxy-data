...
parser.add_argument('--datadir', type=str, default='~/imagenet/', help='location of the data corpus')
parser.add_argument('--dataset', type=str, default='imagenet', help='')
parser.add_argument('--batch_size', type=int, default=64, help='batch size') ## 2080ti: 64, V100: 256
...
parser.add_argument('--workers', type=int, default=2, help='num wokers of data loaders')

################################
## NAS with proxy data options
parser.add_argument('--entropy_file', type=str, 
                    default='./entropy_list/imagenet_resnet50_entropy_file.txt', 
...
parser.add_argument('--histogram_type', type=int, default=1, help='choice: [1, 2, 3]')
################################
...
def main():
  ...
  train_data, _ = utils._data_imagenet(args)
  ...
  if args.random:
    ...
    raise ValueError("[Error] ImageNet search on the cell-based search space must use proxy data")
